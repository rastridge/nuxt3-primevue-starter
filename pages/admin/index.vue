<template>
	<div>
		<nuxt-img src="/imgs/2023_old_blue_dannish.jpg" sizes="sm:70vw" />
		...
		<p>placemark alpha is {{ placemark.getAlpha }}</p>
		<p>placemark membertypeid is {{ placemark.getMemberTypeId }}</p>
		<p>placemark alpha is {{ placemark.getYear }}</p>
